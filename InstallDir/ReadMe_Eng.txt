...
REVIEW
=========
FanPack-Lite, a proprietary configuration package based on built-in filters / decoders.  
Everything is set up, you install the package, launch the player and start watching the videos.

3rd Party Tools:
================
- Icaros (installation file) with according to the license "Icaros License.txt"
  Copyright (c) 2010-2022, Tabibito Technology
  http://shark007.net/tools.html
- madVR (specially prepared installation file) according to the licence "license.txt"
  Copyright (c) 2009-2022 Mathias Rauen
  http://forum.doom9.org/showthread.php?t=146228
- AviSynth[64+] libraries under the "GNU GPL" licence
  https://github.com/pinterf/AviSynthPlus/releases
- SVPflow[64] libraries under the "GNU GPL" licence
  Copyright (c) 2020 SVP-Team.com
  http://www.svp-team.com/wiki/Plugins:_SVPFlow
- Scripts for AviSynth[64]+ and SVPflow[64]
  Copyright (c) 2018-2022 zub35 i 7sh3
- Extension to Twich.tv
...
- Torrent extension
  Downloaded from PotPlayer chat room
  http://cafe.daum.net/pot-tool/N88T/137
- MPC Video Renderer under the "GNU LGPL" licence
...
- TorrServer launcher in accordance with the licence
...
LICENCE AGREEMENT
=================
The condition for the use of FanPack[64] Lite is the agreement to the terms of the licence agreement, 
which in this version of the package is contained in the file License.txt
